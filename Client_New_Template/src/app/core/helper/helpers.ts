...
export class Helpers {
    ...
    public static setArrayLocalStorage(arrData: object[]): void {
        ...
        if (arrData && arrData.length > 0) {
            ...
            arrData.forEach((item: any, index) => {
                if (item) {
    ...
    public static removeDuplicates(array: any, keyChild: string, prop: string): any {
        ...
        if (this.checkLengthObject(array)) {
            ...
            let uniqueData = function (currentArray: any, byKey: string) {
                return currentArray.filter((item: { [x: string]: any; }, index: any) => {
                    return index === currentArray.findIndex((obj: { [x: string]: any; }) => {
            ...
            if (keyChild) {
                resultData.forEach((item: { [x: string]: any; }, index: any) => {
    ...
    */
    ...
    //     function sortComparer(a: string, b: any) {
    //         return a.localeCompare(b)
    //     };

    //     function _sortByAttr(attr: string) {
