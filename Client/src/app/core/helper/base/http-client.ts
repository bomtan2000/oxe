...
export class ApplicationHttpClient {
   ...
   * @returns {Promise<T>}
   */
  public GetAsync<T>(endPoint: string, options?: IRequestOptions): Promise<T | undefined> {
   ...
   * @returns {Promise<T>}
   */
  public PostAsync<T>(endPoint: string, params: Object, options?: IRequestOptions): Promise<T | undefined> {
